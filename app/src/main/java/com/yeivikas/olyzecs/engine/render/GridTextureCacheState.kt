 ...
 * explícitamente en `onSurfaceCreated` — hasta la Fase 3.1 poniendo
 * `Layer.glTextureId = -1` por capa; desde la Fase 3.1, vaciando de una
 * vez el registro `GLRenderer.layerTextures`, ver esa clase).
 *
