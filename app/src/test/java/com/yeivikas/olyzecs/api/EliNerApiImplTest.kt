...
import com.yeivikas.olyzecs.api.render.RenderApiImpl
...
class EliNerApiImplTest {
    ...
    private val pixelColor = FakePixelColorSource()
    private val render: RenderApi = RenderApiImpl(pixelColor)
    ...
    fun `expone cada dominio como exactamente la misma instancia recibida`() {
        ...
        assertSame(pixelColor, api.render.pixelColor)
    ...
    private class FakeAudioApi : AudioApi {
        override fun getAudioClip(): AudioClipSnapshot? = TODO("no usado en esta prueba")
